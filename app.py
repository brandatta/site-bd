...
# ================== SERVICIOS ==================
    ...
    # ---- Estilos servicios: minimal, fondo blanco, rectangulares, bordes rectos ----
    st.markdown("""
    <style>
      ...
      /* Rectángulos minimalistas con bordes rectos */
      .tile {
        width: 240px;                 /* ancho del rectángulo */
      ...
      .card {
        background: #ffffff;
        border: 1px solid #d4fbd7;    /* borde en tu color */
        border-radius: 0;              /* bordes rectos */
        height: 120px;                 /* altura fija => RECTANGULAR */
